import {
  ...
  restaurantClock, type AdId, type ApplianceId, type IngredientId, type RecipeId,
} from "./data";
...
export class RestaurantUI {
  ...
  private updateHud(now: number): void {
    const clock = restaurantClock(now - this.model.serviceStartedAt, this.model.serviceDurationMs);
    ...
    this.setText(".hud-cash b", formatMoney(this.model.cashCents)); this.setText(".hud-time", this.model.phase === "prep" ? "OPENS 11 AM" : clock);
