...
2026-09-15 — Owner approved an optional $150 host who physically greets and escorts the FIFO queue head to a clean table. While employed, outside patience drains at 75% of normal; seated patience is unchanged. The host uses existing training, staff homes, congestion, opening arrival and closing departure. RestaurantDay retains sole authority over customer/table lifecycle through temporary host claims. Restaurants without a host retain automatic seating. No host desk, wages, parties or reservations added.
