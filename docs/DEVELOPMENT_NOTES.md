...
1. Refresh and confirm the new DEV build ID. While still in Browsing Controls, hold Menu (≡) over the canvas and choose Use game controls. If needed, try over the visible Xbox hint or use Edge's address-bar controller icon where offered.
