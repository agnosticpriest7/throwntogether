...
namespace ThrownTogether
{
    ...
    [Serializable] public sealed class ItemPayload
    {
        ...
        public static bool CanPlate(ItemPayload plate,ItemPayload food) => plate!=null && plate.isPlate && !plate.dirty && food!=null && !food.isPlate &&
            food.ingredient!=null && food.state==food.ingredient.platingState && food.additions.Count==0 &&
            (plate.EmptyPlate || plate.additions.Count==0 && plate.ingredient!=food.ingredient && plate.ingredient.combineWith==food.ingredient);
