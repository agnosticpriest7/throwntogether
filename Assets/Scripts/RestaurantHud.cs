    ...
    public sealed class RestaurantHud : MonoBehaviour
    {
        ...
        private void OnGUI()
        {
            ...
            if(day!=null)
            {
                ...
                GUI.Label(new Rect(350,15,670,42),"Day "+day.ServiceDayNumber+" | Bank $"+RestaurantAccounts.Current.Data.cash+" | Today $"+day.NetIncome+(day.AdmissionsClosed?" | Closing: "+day.CustomersRemaining+" leaving / finishing":" | Outside "+day.WaitingOutside+" ("+Mathf.CeilToInt(day.OutsidePatienceRemaining)+"s)")+" | Left "+day.LostCustomers,small);
        ...
        {
            if(!OrderBubbleLayout.Visible(ticket)||ticket.customerVisual==null)return;
