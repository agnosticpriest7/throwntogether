...
namespace ThrownTogether
{
    ...
    public static class SessionOptions
    {
        ...
        public static bool ManageBeforeService {get;set;}
        ...
        private static void Reset() { ShiftOrders=0; Kitchen=0; KeyboardPlayerOne=false; ManageBeforeService=false; Training="Free practice"; }
    }
}
