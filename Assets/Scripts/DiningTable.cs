...
namespace ThrownTogether
{
    ...
    public sealed class DiningTable : Interactable
    {
        ...
        public void ReserveSeat(){Occupied=true;Arriving=true;}
        ...
        public void Depart(){Occupied=false;SetGuestVisible(false);if(order.tableSlot.Item==null)order.ResetOrder(null);}
        ...
        public bool CanServe(ItemPayload dish)=>!day.Closed && !Arriving && Occupied && order.tableSlot.Item==null && order.CanAccept(dish);
